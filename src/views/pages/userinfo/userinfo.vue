  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    >
      ...
      <template slot="thead">
        ...
        <vs-th v-show="$route.query == 'utc'">ลบข้อมูลผู้ดูแล</vs-th>
            ...
            <vs-td>
              <div>
                <feather-icon
                  ...
                  class="ml-2"
                  @click.stop="deleteUpper(tr.key, tr.upper)"
                />
                <!-- <p>{{ switch2 }}</p> -->
              </div>
            </vs-td>
...
export default {
  ...
  methods: {
    ...
    async deleteUpper(key, upper) {
      console.log(upper);
      const type = await this.gettype();
      // alert(role);
      if (upper.stateopen == undefined || upper.stateopen == false) {
        // alert("true");
        this.$vs.loading();
        await userRef
          .child(type)
